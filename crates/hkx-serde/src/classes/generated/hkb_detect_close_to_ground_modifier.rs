...
pub enum HkbDetectCloseToGroundModifier {
    ...
    /// - offset: 44
    /// -  flags: `FLAGS_NONE`
    #[serde(rename = "closeToGroundEvent", default)]
    ...
    /// - offset: 52
    /// -  flags: `FLAGS_NONE`
    #[serde(rename = "closeToGroundHeight", default)]
    ...
    /// - offset: 66
    /// -  flags: `FLAGS_NONE`
    #[serde(rename = "animBoneIndex", default)]
    ...
    /// - offset: 68
    /// -  flags: `FLAGS_NONE | SERIALIZE_IGNORED`
    #[serde(rename = "isCloseToGround", default, skip_serializing)]
