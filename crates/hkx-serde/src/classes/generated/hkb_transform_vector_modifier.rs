...
pub enum HkbTransformVectorModifier {
    ...
    /// - offset: 96
    /// -  flags: `FLAGS_NONE`
    #[serde(rename = "vectorOut", default)]
    ...
    /// - offset: 112
    /// -  flags: `FLAGS_NONE`
    #[serde(rename = "rotateOnly", default)]
    ...
    /// - offset: 114
    /// -  flags: `FLAGS_NONE`
    #[serde(rename = "computeOnActivate", default)]
    ...
    /// - offset: 115
    /// -  flags: `FLAGS_NONE`
    #[serde(rename = "computeOnModify", default)]
