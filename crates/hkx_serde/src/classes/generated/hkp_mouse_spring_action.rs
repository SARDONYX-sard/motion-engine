...
pub struct HkpMouseSpringAction<'a> {
    ...
    /// - offset: 32
    /// -  flags: `FLAGS_NONE`
    position_in_rb_local: Vector4<f32>,
    /// # C++ Class Fields Info
    /// -   name:`"mousePositionInWorld"`
    /// -   type: `hkVector4`
    /// - offset: 48
    /// -  flags: `FLAGS_NONE`
    mouse_position_in_world: Vector4<f32>,
    /// # C++ Class Fields Info
    /// -   name:`"springDamping"`
    /// -   type: `hkReal`
    /// - offset: 64
    ...
    /// - offset: 68
    /// -  flags: `FLAGS_NONE`
    spring_elasticity: f32,
    /// # C++ Class Fields Info
    /// -   name:`"maxRelativeForce"`
    /// -   type: `hkReal`
    /// - offset: 72
    /// -  flags: `FLAGS_NONE`
    max_relative_force: f32,
    /// # C++ Class Fields Info
    /// -   name:`"objectDamping"`
    /// -   type: `hkReal`
    /// - offset: 76
    ...
    /// - offset: 84
    /// -  flags: `FLAGS_NONE|SERIALIZE_IGNORED`
    apply_callbacks: HkArrayRef<Cow<'a, str>>,
}
...
impl ByteDeSerialize for HkpMouseSpringAction<'_> {
    fn from_bytes<B>(
        _bytes: &[u8],
...
#[serde(tag = "@name")]
pub enum HkpMouseSpringActionVisitor<'a> {
    /// Visitor fields
    #[serde(rename = "entity")]
