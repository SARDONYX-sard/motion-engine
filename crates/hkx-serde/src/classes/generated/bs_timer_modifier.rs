...
pub enum BsTimerModifier {
    ...
    /// - offset: 44
    /// -  flags: `FLAGS_NONE`
    #[serde(rename = "alarmTimeSeconds", default)]
    ...
    /// - offset: 48
    /// -  flags: `FLAGS_NONE`
    #[serde(rename = "alarmEvent", default)]
    ...
    /// - offset: 56
    /// -  flags: `FLAGS_NONE`
    #[serde(rename = "resetAlarm", default)]
    ...
    /// - offset: 60
    /// -  flags: `FLAGS_NONE | SERIALIZE_IGNORED`
    #[serde(rename = "secondsElapsed", default, skip_serializing)]
