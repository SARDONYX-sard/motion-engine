...
pub struct HkpGravityGun<'a> {
    ...
    /// - offset: 32
    /// -  flags: `FLAGS_NONE|SERIALIZE_IGNORED`
    grabbed_bodies: HkArrayRef<Cow<'a, str>>,
    /// # C++ Class Fields Info
    /// -   name:`"maxNumObjectsPicked"`
    /// -   type: `hkInt32`
    /// - offset: 44
    /// -  flags: `FLAGS_NONE`
    max_num_objects_picked: i32,
    /// # C++ Class Fields Info
    /// -   name:`"maxMassOfObjectPicked"`
    /// -   type: `hkReal`
    /// - offset: 48
    /// -  flags: `FLAGS_NONE`
    max_mass_of_object_picked: f32,
    /// # C++ Class Fields Info
    /// -   name:`"maxDistOfObjectPicked"`
    /// -   type: `hkReal`
    /// - offset: 52
    /// -  flags: `FLAGS_NONE`
    max_dist_of_object_picked: f32,
    /// # C++ Class Fields Info
    /// -   name:`"impulseAppliedWhenObjectNotPicked"`
    /// -   type: `hkReal`
    /// - offset: 56
    /// -  flags: `FLAGS_NONE`
    impulse_applied_when_object_not_picked: f32,
    /// # C++ Class Fields Info
    /// -   name:`"throwVelocity"`
    /// -   type: `hkReal`
    /// - offset: 60
    ...
    /// - offset: 64
    /// -  flags: `FLAGS_NONE`
    captured_object_position: Vector4<f32>,
    /// # C++ Class Fields Info
    /// -   name:`"capturedObjectsOffset"`
    /// -   type: `hkVector4`
    /// - offset: 80
    /// -  flags: `FLAGS_NONE`
    captured_objects_offset: Vector4<f32>,
}
...
impl ByteDeSerialize for HkpGravityGun<'_> {
    fn from_bytes<B>(
        _bytes: &[u8],
...
#[serde(tag = "@name")]
pub enum HkpGravityGunVisitor<'a> {
    /// Visitor fields
