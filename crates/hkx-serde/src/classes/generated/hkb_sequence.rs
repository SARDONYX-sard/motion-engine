...
pub enum HkbSequence<'a> {
    ...
    /// - offset: 44
    /// -  flags: `FLAGS_NONE`
    #[serde(rename = "eventSequencedData", default)]
    ...
    /// - offset: 56
    /// -  flags: `FLAGS_NONE`
    #[serde(rename = "realVariableSequencedData", default)]
    ...
    /// - offset: 68
    /// -  flags: `FLAGS_NONE`
    #[serde(rename = "boolVariableSequencedData", default)]
    ...
    /// - offset: 80
    /// -  flags: `FLAGS_NONE`
    #[serde(rename = "intVariableSequencedData", default)]
    ...
    /// - offset: 92
    /// -  flags: `FLAGS_NONE`
    #[serde(rename = "enableEventId", default)]
    ...
    /// - offset: 96
    /// -  flags: `FLAGS_NONE`
    #[serde(rename = "disableEventId", default)]
    ...
    /// - offset: 112
    /// -  flags: `FLAGS_NONE | SERIALIZE_IGNORED`
    #[serde(rename = "nextSampleEvents", default, skip_serializing)]
    ...
    /// - offset: 124
    /// -  flags: `FLAGS_NONE | SERIALIZE_IGNORED`
    #[serde(rename = "nextSampleReals", default, skip_serializing)]
    ...
    /// - offset: 136
    /// -  flags: `FLAGS_NONE | SERIALIZE_IGNORED`
    #[serde(rename = "nextSampleBools", default, skip_serializing)]
    ...
    /// - offset: 148
    /// -  flags: `FLAGS_NONE | SERIALIZE_IGNORED`
    #[serde(rename = "nextSampleInts", default, skip_serializing)]
    ...
    /// - offset: 164
    /// -  flags: `FLAGS_NONE | SERIALIZE_IGNORED`
    #[serde(rename = "isEnabled", default, skip_serializing)]
