...
pub struct HkaAnimationPreviewColorContainer<'a> {
    ...
    /// `"hkaAnimationPreviewColorContainer"`: The original C++ class name.
...
impl HkaAnimationPreviewColorContainer<'_> {
    /// Return `"hkaAnimationPreviewColorContainer"`, which is the name of this C++ class.
    ///
    /// # NOTE
...
pub enum HkaAnimationPreviewColorContainerHkParam<'a> {
    ...
    PreviewColor(Vec<Primitive<u32>>),
}
...
impl_deserialize_for_internally_tagged_enum! {
    ...
    ("previewColor" => PreviewColor(Vec<Primitive<u32>>)),
}
