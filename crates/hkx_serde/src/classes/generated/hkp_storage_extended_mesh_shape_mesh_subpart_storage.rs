...
impl ByteDeSerialize for HkpStorageExtendedMeshShapeMeshSubpartStorage<'_> {
    fn from_bytes<B>(
        _bytes: &[u8],
...
#[serde(tag = "@name")]
pub enum HkpStorageExtendedMeshShapeMeshSubpartStorageVisitor<'a> {
    /// Visitor fields
