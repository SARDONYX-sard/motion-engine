...
pub struct HkpTyremarksInfo<'a> {
    ...
    /// - offset: 8
    /// -  flags: `FLAGS_NONE`
    min_tyremark_energy: f32,
    /// # C++ Class Fields Info
    /// -   name:`"maxTyremarkEnergy"`
    /// -   type: `hkReal`
    /// - offset: 12
    /// -  flags: `FLAGS_NONE`
    max_tyremark_energy: f32,
    /// # C++ Class Fields Info
    /// -   name:`"tyremarksWheel"`
    /// -   type: `hkArray<hkpTyremarksWheel*>`
    /// - offset: 16
    /// -  flags: `FLAGS_NONE`
    tyremarks_wheel: HkArrayRef<Cow<'a, str>>,
}
...
impl ByteDeSerialize for HkpTyremarksInfo<'_> {
    fn from_bytes<B>(
        _bytes: &[u8],
...
#[serde(tag = "@name")]
pub enum HkpTyremarksInfoVisitor<'a> {
    /// Visitor fields
