...
pub enum HkbGeneratorTransitionEffect<'a> {
    ...
    /// - offset: 44
    /// -  flags: `FLAGS_NONE`
    #[serde(rename = "transitionGenerator", default)]
    ...
    /// - offset: 48
    /// -  flags: `FLAGS_NONE`
    #[serde(rename = "blendInDuration", default)]
    ...
    /// - offset: 52
    /// -  flags: `FLAGS_NONE`
    #[serde(rename = "blendOutDuration", default)]
    ...
    /// - offset: 56
    /// -  flags: `FLAGS_NONE`
    #[serde(rename = "syncToGeneratorStartTime", default)]
    ...
    /// - offset: 72
    /// -  flags: `FLAGS_NONE | SERIALIZE_IGNORED`
    #[serde(rename = "duration", default, skip_serializing)]
    ...
    /// - offset: 76
    /// -  flags: `FLAGS_NONE | SERIALIZE_IGNORED`
    #[serde(rename = "effectiveBlendInDuration", default, skip_serializing)]
    ...
    /// - offset: 80
    /// -  flags: `FLAGS_NONE | SERIALIZE_IGNORED`
    #[serde(rename = "effectiveBlendOutDuration", default, skip_serializing)]
    ...
    /// - offset: 84
    /// -  flags: `FLAGS_NONE | SERIALIZE_IGNORED`
    #[serde(rename = "toGeneratorState", default, skip_serializing)]
    ...
    /// - offset: 85
    /// -  flags: `FLAGS_NONE | SERIALIZE_IGNORED`
    #[serde(rename = "echoTransitionGenerator", default, skip_serializing)]
    ...
    /// - offset: 86
    /// -  flags: `FLAGS_NONE | SERIALIZE_IGNORED`
    #[serde(rename = "echoToGenerator", default, skip_serializing)]
    ...
    /// - offset: 87
    /// -  flags: `FLAGS_NONE | SERIALIZE_IGNORED`
    #[serde(rename = "justActivated", default, skip_serializing)]
    ...
    /// - offset: 89
    /// -  flags: `FLAGS_NONE | SERIALIZE_IGNORED`
    #[serde(rename = "stage", default, skip_serializing)]
