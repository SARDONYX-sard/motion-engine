...
pub struct HkpExtendedMeshShapeTrianglesSubpart<'a> {
    ...
    /// - offset: 46
    /// -  flags: `FLAGS_NONE`
    striding_type: IndexStridingType,
    /// # C++ Class Fields Info
    /// -   name:`"flipAlternateTriangles"`
    /// -   type: `hkInt8`
    /// - offset: 47
    /// -  flags: `FLAGS_NONE`
    flip_alternate_triangles: i8,
    /// # C++ Class Fields Info
    /// -   name:`"extrusion"`
    /// -   type: `hkVector4`
    /// - offset: 48
...
impl ByteDeSerialize for HkpExtendedMeshShapeTrianglesSubpart<'_> {
    fn from_bytes<B>(
        _bytes: &[u8],
...
#[serde(tag = "@name")]
pub enum HkpExtendedMeshShapeTrianglesSubpartVisitor<'a> {
    /// Visitor fields
    #[serde(rename = "type")]
