...
pub struct HkbEvaluateExpressionModifierInternalState<'a> {
    ...
    /// `"hkbEvaluateExpressionModifierInternalState"`: The original C++ class name.
...
impl HkbEvaluateExpressionModifierInternalState<'_> {
    /// Return `"hkbEvaluateExpressionModifierInternalState"`, which is the name of this C++ class.
    ///
    /// # NOTE
