...
pub struct BsDistTriggerModifier<'a> {
    ...
    /// - offset: 68
    /// -  flags: `FLAGS_NONE`
    distance_trigger: f32,
    /// # C++ Class Fields Info
    /// -   name:`"triggerEvent"`
    /// -   type: `struct hkbEventProperty`
    /// - offset: 72
    /// -  flags: `FLAGS_NONE`
    trigger_event: SingleClass<HkbEventProperty<'a>>,
}
...
impl ByteDeSerialize for BsDistTriggerModifier<'_> {
    fn from_bytes<B>(
        _bytes: &[u8],
...
#[serde(tag = "@name")]
pub enum BsDistTriggerModifierVisitor<'a> {
    /// Visitor fields
    #[serde(rename = "enable")]
