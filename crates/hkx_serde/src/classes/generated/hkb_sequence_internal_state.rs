...
pub struct HkbSequenceInternalState {
    ...
    /// - offset: 8
    /// -  flags: `FLAGS_NONE`
    next_sample_events: HkArrayNum<i32>,
    /// # C++ Class Fields Info
    /// -   name:`"nextSampleReals"`
    /// -   type: `hkArray<hkInt32>`
    /// - offset: 20
    /// -  flags: `FLAGS_NONE`
    next_sample_reals: HkArrayNum<i32>,
    /// # C++ Class Fields Info
    /// -   name:`"nextSampleBools"`
    /// -   type: `hkArray<hkInt32>`
    /// - offset: 32
    /// -  flags: `FLAGS_NONE`
    next_sample_bools: HkArrayNum<i32>,
    /// # C++ Class Fields Info
    /// -   name:`"nextSampleInts"`
    /// -   type: `hkArray<hkInt32>`
    /// - offset: 44
    /// -  flags: `FLAGS_NONE`
    next_sample_ints: HkArrayNum<i32>,
    /// # C++ Class Fields Info
    /// -   name:`"time"`
    /// -   type: `hkReal`
    /// - offset: 56
...
#[serde(tag = "@name")]
pub enum HkbSequenceInternalStateVisitor {
    /// Visitor fields
