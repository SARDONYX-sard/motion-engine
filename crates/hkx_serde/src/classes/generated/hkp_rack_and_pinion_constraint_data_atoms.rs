...
pub struct HkpRackAndPinionConstraintDataAtoms {
    ...
    /// - offset: 144
    /// -  flags: `FLAGS_NONE`
    pub rack_and_pinion: SingleClass<HkpRackAndPinionConstraintAtom>,
}
...
impl <'bytes: 'de, 'de> ByteDeSerialize<'bytes, 'de> for HkpRackAndPinionConstraintDataAtoms {
    fn from_bytes<B>(
        _bytes: &'bytes [u8],
...
#[serde(tag = "@name")]
enum HkpRackAndPinionConstraintDataAtomsVisitor {
    /// Visitor fields
