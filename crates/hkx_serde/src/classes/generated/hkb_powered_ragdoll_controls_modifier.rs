...
pub struct HkbPoweredRagdollControlsModifier<'a> {
    ...
    /// - offset: 48
    /// -  flags: `FLAGS_NONE`
    pub control_data: SingleClass<HkbPoweredRagdollControlData>,
    /// # C++ Class Fields Info
    /// -   name:`"bones"`
    ...
    /// - offset: 84
    /// -  flags: `FLAGS_NONE`
    pub world_from_model_mode_data: SingleClass<HkbWorldFromModelModeData>,
    /// # C++ Class Fields Info
    /// -   name:`"boneWeights"`
...
impl <'bytes: 'de, 'de> ByteDeSerialize<'bytes, 'de> for HkbPoweredRagdollControlsModifier<'de> {
    fn from_bytes<B>(
        _bytes: &'bytes [u8],
...
#[serde(tag = "@name")]
enum HkbPoweredRagdollControlsModifierVisitor<'a> {
    /// Visitor fields
    #[serde(rename = "enable")]
...
impl_deserialize_for_internally_tagged_enum! {
    ...
    ("controlData" => ControlData(SingleClass<HkbPoweredRagdollControlData>)),
