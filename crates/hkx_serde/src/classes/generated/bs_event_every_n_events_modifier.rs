...
pub struct BsEventEveryNEventsModifier<'a> {
    ...
    /// - offset: 44
    /// -  flags: `FLAGS_NONE`
    event_to_check_for: SingleClass<HkbEventProperty<'a>>,
    /// # C++ Class Fields Info
    /// -   name:`"eventToSend"`
    /// -   type: `struct hkbEventProperty`
    /// - offset: 52
    /// -  flags: `FLAGS_NONE`
    event_to_send: SingleClass<HkbEventProperty<'a>>,
    /// # C++ Class Fields Info
    /// -   name:`"numberOfEventsBeforeSend"`
    /// -   type: `hkInt8`
    /// - offset: 60
    /// -  flags: `FLAGS_NONE`
    number_of_events_before_send: i8,
    /// # C++ Class Fields Info
    /// -   name:`"minimumNumberOfEventsBeforeSend"`
    /// -   type: `hkInt8`
    /// - offset: 61
    /// -  flags: `FLAGS_NONE`
    minimum_number_of_events_before_send: i8,
    /// # C++ Class Fields Info
    /// -   name:`"randomizeNumberOfEvents"`
    /// -   type: `hkBool`
    /// - offset: 62
    /// -  flags: `FLAGS_NONE`
    randomize_number_of_events: bool,
    /// # C++ Class Fields Info
    /// -   name:`"numberOfEventsSeen"`
    /// -   type: `hkInt32`
    /// - offset: 64
    /// -  flags: `FLAGS_NONE|SERIALIZE_IGNORED`
    number_of_events_seen: i32,
    /// # C++ Class Fields Info
    /// -   name:`"calculatedNumberOfEventsBeforeSend"`
    /// -   type: `hkInt8`
    /// - offset: 68
    /// -  flags: `FLAGS_NONE|SERIALIZE_IGNORED`
    calculated_number_of_events_before_send: i8,
}
...
impl ByteDeSerialize for BsEventEveryNEventsModifier<'_> {
    fn from_bytes<B>(
        _bytes: &[u8],
...
#[serde(tag = "@name")]
pub enum BsEventEveryNEventsModifierVisitor<'a> {
    /// Visitor fields
    #[serde(rename = "enable")]
