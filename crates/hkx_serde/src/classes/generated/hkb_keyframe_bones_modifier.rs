...
pub struct HkbKeyframeBonesModifier<'a> {
    ...
    /// - offset: 44
    /// -  flags: `FLAGS_NONE`
    keyframe_info: HkArrayClass<HkbKeyframeBonesModifierKeyframeInfo>,
    /// # C++ Class Fields Info
    /// -   name:`"keyframedBonesList"`
    /// -   type: `struct hkbBoneIndexArray*`
    /// - offset: 56
    /// -  flags: `FLAGS_NONE`
    keyframed_bones_list: Cow<'a, str>,
}
...
impl ByteDeSerialize for HkbKeyframeBonesModifier<'_> {
    fn from_bytes<B>(
        _bytes: &[u8],
...
#[serde(tag = "@name")]
pub enum HkbKeyframeBonesModifierVisitor<'a> {
    /// Visitor fields
    #[serde(rename = "enable")]
