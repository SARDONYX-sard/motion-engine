...
pub struct HkpCylinderShape {
    ...
    /// - offset: 24
    /// -  flags: `FLAGS_NONE`
    cyl_base_radius_factor_for_height_field_collisions: f32,
    /// # C++ Class Fields Info
    /// -   name:`"vertexA"`
    /// -   type: `hkVector4`
    /// - offset: 32
    ...
    /// - offset: 64
    /// -  flags: `FLAGS_NONE`
    perpendicular_1: Vector4<f32>,
    /// # C++ Class Fields Info
    /// -   name:`"perpendicular2"`
    /// -   type: `hkVector4`
    /// - offset: 80
    /// -  flags: `FLAGS_NONE`
    perpendicular_2: Vector4<f32>,
}
...
impl ByteDeSerialize for HkpCylinderShape {
    fn from_bytes<B>(
        _bytes: &[u8],
...
#[serde(tag = "@name")]
pub enum HkpCylinderShapeVisitor {
    /// Visitor fields
    #[serde(rename = "radius")]
