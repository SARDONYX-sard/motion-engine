...
pub struct HkxMaterialShaderSet<'a> {
    ...
    /// `"hkxMaterialShaderSet"`: The original C++ class name.
...
impl HkxMaterialShaderSet<'_> {
    /// Return `"hkxMaterialShaderSet"`, which is the name of this C++ class.
    ///
    /// # NOTE
