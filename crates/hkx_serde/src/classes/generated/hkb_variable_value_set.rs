...
pub struct HkbVariableValueSet<'a> {
    ...
    /// - offset: 8
    /// -  flags: `FLAGS_NONE`
    word_variable_values: HkArrayClass<HkbVariableValue>,
    /// # C++ Class Fields Info
    /// -   name:`"quadVariableValues"`
    /// -   type: `hkArray<hkVector4>`
    /// - offset: 20
    /// -  flags: `FLAGS_NONE`
    quad_variable_values: HkArrayVector<Vector4<f32>>,
    /// # C++ Class Fields Info
    /// -   name:`"variantVariableValues"`
    /// -   type: `hkArray<hkReferencedObject*>`
    /// - offset: 32
    /// -  flags: `FLAGS_NONE`
    variant_variable_values: HkArrayRef<Cow<'a, str>>,
}
...
impl ByteDeSerialize for HkbVariableValueSet<'_> {
    fn from_bytes<B>(
        _bytes: &[u8],
...
#[serde(tag = "@name")]
pub enum HkbVariableValueSetVisitor<'a> {
    /// Visitor fields
