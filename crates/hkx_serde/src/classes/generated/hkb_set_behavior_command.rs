...
pub struct HkbSetBehaviorCommand<'a> {
    ...
    /// - offset: 24
    /// -  flags: `FLAGS_NONE`
    referenced_behaviors: HkArrayRef<Cow<'a, str>>,
    /// # C++ Class Fields Info
...
impl ByteDeSerialize for HkbSetBehaviorCommand<'_> {
    fn from_bytes<B>(
        _bytes: &[u8],
...
#[serde(tag = "@name")]
pub enum HkbSetBehaviorCommandVisitor<'a> {
    /// Visitor fields
