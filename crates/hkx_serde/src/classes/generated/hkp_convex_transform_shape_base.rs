...
pub struct HkpConvexTransformShapeBase<'a> {
    ...
    /// - offset: 20
    /// -  flags: `FLAGS_NONE`
    child_shape: SingleClass<HkpSingleShapeContainer<'a>>,
    /// # C++ Class Fields Info
    /// -   name:`"childShapeSize"`
    /// -   type: `hkInt32`
    /// - offset: 28
    /// -  flags: `FLAGS_NONE|SERIALIZE_IGNORED`
    child_shape_size: i32,
}
...
impl ByteDeSerialize for HkpConvexTransformShapeBase<'_> {
    fn from_bytes<B>(
        _bytes: &[u8],
...
#[serde(tag = "@name")]
pub enum HkpConvexTransformShapeBaseVisitor<'a> {
    /// Visitor fields
    #[serde(rename = "radius")]
