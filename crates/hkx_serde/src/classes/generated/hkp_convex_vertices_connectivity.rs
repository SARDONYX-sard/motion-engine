...
pub struct HkpConvexVerticesConnectivity {
    ...
    /// - offset: 8
    /// -  flags: `FLAGS_NONE`
    vertex_indices: HkArrayNum<u16>,
    /// # C++ Class Fields Info
    /// -   name:`"numVerticesPerFace"`
    /// -   type: `hkArray<hkUint8>`
    /// - offset: 20
    /// -  flags: `FLAGS_NONE`
    num_vertices_per_face: HkArrayNum<u8>,
}
...
impl ByteDeSerialize for HkpConvexVerticesConnectivity {
    fn from_bytes<B>(
        _bytes: &[u8],
...
#[serde(tag = "@name")]
pub enum HkpConvexVerticesConnectivityVisitor {
    /// Visitor fields
