...
pub struct HkpSimpleShapePhantomCollisionDetail<'a> {
    ...
    /// `"hkpSimpleShapePhantomCollisionDetail"`: The original C++ class name.
...
impl HkpSimpleShapePhantomCollisionDetail<'_> {
    /// Return `"hkpSimpleShapePhantomCollisionDetail"`, which is the name of this C++ class.
    ///
    /// # NOTE
...
impl_deserialize_for_internally_tagged_enum! {
    ...
    ("collidable" => Collidable(Cow<'a, str>)),
}
