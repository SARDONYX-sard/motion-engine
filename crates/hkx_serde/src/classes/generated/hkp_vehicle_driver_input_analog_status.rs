//! Rust [`serde::Serializer`]/[`serde::Deserializer`] corresponding to C++ class `hkpVehicleDriverInputAnalogStatus`
//!
//! # NOTE
...
pub struct HkpVehicleDriverInputAnalogStatus {
    ...
    /// - offset: 16
    /// -  flags: `FLAGS_NONE`
    pub handbrake_button_pressed: bool,
    /// # C++ Class Fields Info
    /// -   name:`"reverseButtonPressed"`
    /// -   type: `hkBool`
    /// - offset: 17
    /// -  flags: `FLAGS_NONE`
    pub reverse_button_pressed: bool,
}
...
impl <'bytes: 'de, 'de> ByteDeSerialize<'bytes, 'de> for HkpVehicleDriverInputAnalogStatus {
    fn from_bytes<B>(
        _bytes: &'bytes [u8],
...
#[serde(tag = "@name")]
enum HkpVehicleDriverInputAnalogStatusVisitor {
    // C++ Parent class(`hkpVehicleDriverInputStatus` => parent: `hkReferencedObject`) has no fields
    //
    /// Visitor fields
