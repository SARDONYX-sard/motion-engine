...
pub struct HkaWaveletCompressedAnimationQuantizationFormat<'a> {
    ...
    /// `"hkaWaveletCompressedAnimationQuantizationFormat"`: The original C++ class name.
...
impl HkaWaveletCompressedAnimationQuantizationFormat<'_> {
    /// Return `"hkaWaveletCompressedAnimationQuantizationFormat"`, which is the name of this C++ class.
    ///
    /// # NOTE
