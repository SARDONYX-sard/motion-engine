...
pub struct HkpCenterOfMassChangerModifierConstraintAtom<'a> {
    ...
    /// - offset: 32
    /// -  flags: `FLAGS_NONE`
    displacement_a: Vector4<f32>,
    /// # C++ Class Fields Info
    /// -   name:`"displacementB"`
    /// -   type: `hkVector4`
    /// - offset: 48
    /// -  flags: `FLAGS_NONE`
    displacement_b: Vector4<f32>,
}
...
impl ByteDeSerialize for HkpCenterOfMassChangerModifierConstraintAtom<'_> {
    fn from_bytes<B>(
        _bytes: &[u8],
...
#[serde(tag = "@name")]
pub enum HkpCenterOfMassChangerModifierConstraintAtomVisitor<'a> {
    /// Visitor fields
