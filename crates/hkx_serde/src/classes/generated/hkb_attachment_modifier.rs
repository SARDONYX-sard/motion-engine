...
pub struct HkbAttachmentModifier<'a> {
    ...
    /// - offset: 44
    /// -  flags: `FLAGS_NONE`
    send_to_attacher_on_attach: SingleClass<HkbEventProperty<'a>>,
    /// # C++ Class Fields Info
    /// -   name:`"sendToAttacheeOnAttach"`
    /// -   type: `struct hkbEventProperty`
    /// - offset: 52
    /// -  flags: `FLAGS_NONE`
    send_to_attachee_on_attach: SingleClass<HkbEventProperty<'a>>,
    /// # C++ Class Fields Info
    /// -   name:`"sendToAttacherOnDetach"`
    /// -   type: `struct hkbEventProperty`
    /// - offset: 60
    /// -  flags: `FLAGS_NONE`
    send_to_attacher_on_detach: SingleClass<HkbEventProperty<'a>>,
    /// # C++ Class Fields Info
    /// -   name:`"sendToAttacheeOnDetach"`
    /// -   type: `struct hkbEventProperty`
    /// - offset: 68
    /// -  flags: `FLAGS_NONE`
    send_to_attachee_on_detach: SingleClass<HkbEventProperty<'a>>,
    /// # C++ Class Fields Info
    /// -   name:`"attachmentSetup"`
    /// -   type: `struct hkbAttachmentSetup*`
    /// - offset: 76
    /// -  flags: `FLAGS_NONE`
    attachment_setup: Cow<'a, str>,
    /// # C++ Class Fields Info
    /// -   name:`"attacherHandle"`
    /// -   type: `struct hkbHandle*`
    /// - offset: 80
    /// -  flags: `FLAGS_NONE`
    attacher_handle: Cow<'a, str>,
    /// # C++ Class Fields Info
    /// -   name:`"attacheeHandle"`
    /// -   type: `struct hkbHandle*`
    /// - offset: 84
    /// -  flags: `FLAGS_NONE`
    attachee_handle: Cow<'a, str>,
    /// # C++ Class Fields Info
    /// -   name:`"attacheeLayer"`
    /// -   type: `hkInt32`
    /// - offset: 88
...
impl ByteDeSerialize for HkbAttachmentModifier<'_> {
    fn from_bytes<B>(
        _bytes: &[u8],
...
#[serde(tag = "@name")]
pub enum HkbAttachmentModifierVisitor<'a> {
    /// Visitor fields
    #[serde(rename = "enable")]
