...
pub struct HkpGroupFilter {
    ...
    /// - offset: 48
    /// -  flags: `FLAGS_NONE`
    next_free_system_group: i32,
    /// # C++ Class Fields Info
    /// -   name:`"collisionLookupTable"`
    /// -   type: `hkUint32[32]`
    /// - offset: 52
    /// -  flags: `FLAGS_NONE`
    collision_lookup_table: CStyleArray<[u32; 32]>,
    /// # C++ Class Fields Info
    /// -   name:`"pad256"`
    /// -   type: `hkVector4[4]`
    /// - offset: 192
    /// -  flags: `FLAGS_NONE`
    pad_256: CStyleArrayVector<Vector4<f32>, 4>,
}
...
impl ByteDeSerialize for HkpGroupFilter {
    fn from_bytes<B>(
        _bytes: &[u8],
...
#[serde(tag = "@name")]
pub enum HkpGroupFilterVisitor {
    /// Visitor fields
    #[serde(rename = "prepad")]
    Prepad(CStyleArray<[u32; 2]>),
    /// Visitor fields
