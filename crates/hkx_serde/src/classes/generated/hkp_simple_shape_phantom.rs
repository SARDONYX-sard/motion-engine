...
pub struct HkpSimpleShapePhantom<'a> {
    ...
    /// - offset: 352
    /// -  flags: `FLAGS_NONE|SERIALIZE_IGNORED`
    collision_details: HkArrayClass<HkpSimpleShapePhantomCollisionDetail<'a>>,
    /// # C++ Class Fields Info
    /// -   name:`"orderDirty"`
    /// -   type: `hkBool`
    /// - offset: 364
...
impl ByteDeSerialize for HkpSimpleShapePhantom<'_> {
    fn from_bytes<B>(
        _bytes: &[u8],
...
#[serde(tag = "@name")]
pub enum HkpSimpleShapePhantomVisitor<'a> {
    /// Visitor fields
