...
pub enum HkbGetUpModifier {
    ...
    /// - offset: 48
    /// -  flags: `FLAGS_NONE`
    #[serde(rename = "groundNormal", default)]
    ...
    /// - offset: 68
    /// -  flags: `FLAGS_NONE`
    #[serde(rename = "alignWithGroundDuration", default)]
    ...
    /// - offset: 80
    /// -  flags: `FLAGS_NONE | SERIALIZE_IGNORED`
    #[serde(rename = "timeSinceBegin", default, skip_serializing)]
    ...
    /// - offset: 88
    /// -  flags: `FLAGS_NONE | SERIALIZE_IGNORED`
    #[serde(rename = "initNextModify", default, skip_serializing)]
