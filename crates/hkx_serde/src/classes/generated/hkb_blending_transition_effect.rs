...
pub struct HkbBlendingTransitionEffect<'a> {
    ...
    /// - offset: 40
    /// -  flags: `FLAGS_NONE`
    self_transition_mode: SelfTransitionMode,
    /// # C++ Parent class(`hkbTransitionEffect` => parent: `hkbGenerator`) field Info
    /// -   name:`"eventMode"`
    /// -   type: `enum EventMode`
    /// - offset: 41
    ...
    /// - offset: 48
    /// -  flags: `FLAGS_NONE`
    to_generator_start_time_fraction: f32,
    /// # C++ Class Fields Info
    /// -   name:`"flags"`
    /// -   type: `flags FlagBits`
    /// - offset: 52
    ...
    /// - offset: 56
    /// -  flags: `FLAGS_NONE|SERIALIZE_IGNORED`
    from_generator: Cow<'a, str>,
    /// # C++ Class Fields Info
    /// -   name:`"toGenerator"`
    /// -   type: `void*`
    /// - offset: 60
    /// -  flags: `FLAGS_NONE|SERIALIZE_IGNORED`
    to_generator: Cow<'a, str>,
    /// # C++ Class Fields Info
    /// -   name:`"characterPoseAtBeginningOfTransition"`
    /// -   type: `hkArray<void>`
    /// - offset: 64
    /// -  flags: `FLAGS_NONE|SERIALIZE_IGNORED`
    character_pose_at_beginning_of_transition: HkArrayRef<()>,
    /// # C++ Class Fields Info
    /// -   name:`"timeRemaining"`
    /// -   type: `hkReal`
    /// - offset: 76
...
#[serde(tag = "@name")]
pub enum HkbBlendingTransitionEffectVisitor<'a> {
    /// Visitor fields
