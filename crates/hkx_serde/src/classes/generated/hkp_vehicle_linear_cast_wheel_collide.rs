...
pub struct HkpVehicleLinearCastWheelCollide<'a> {
    ...
    /// - offset: 12
    /// -  flags: `FLAGS_NONE`
    wheel_collision_filter_info: u32,
    /// # C++ Class Fields Info
    /// -   name:`"wheelStates"`
    /// -   type: `hkArray<struct hkpVehicleLinearCastWheelCollideWheelState>`
    /// - offset: 16
    /// -  flags: `FLAGS_NONE`
    wheel_states: HkArrayClass<HkpVehicleLinearCastWheelCollideWheelState<'a>>,
    /// # C++ Class Fields Info
    /// -   name:`"rejectChassisListener"`
    /// -   type: `struct hkpRejectChassisListener`
    /// - offset: 28
    /// -  flags: `FLAGS_NONE`
    reject_chassis_listener: SingleClass<HkpRejectChassisListener<'a>>,
    /// # C++ Class Fields Info
...
impl ByteDeSerialize for HkpVehicleLinearCastWheelCollide<'_> {
    fn from_bytes<B>(
        _bytes: &[u8],
...
#[serde(tag = "@name")]
pub enum HkpVehicleLinearCastWheelCollideVisitor<'a> {
    /// Visitor fields
