...
pub struct HkpVehicleDefaultVelocityDamper {
    ...
    /// - offset: 8
    /// -  flags: `FLAGS_NONE`
    normal_spin_damping: f32,
    /// # C++ Class Fields Info
    /// -   name:`"collisionSpinDamping"`
    /// -   type: `hkReal`
    /// - offset: 12
    /// -  flags: `FLAGS_NONE`
    collision_spin_damping: f32,
    /// # C++ Class Fields Info
...
impl ByteDeSerialize for HkpVehicleDefaultVelocityDamper {
    fn from_bytes<B>(
        _bytes: &[u8],
...
#[serde(tag = "@name")]
pub enum HkpVehicleDefaultVelocityDamperVisitor {
    // C++ Parent class(`hkpVehicleVelocityDamper` => parent: `hkReferencedObject`) has no fields
    //
    /// Visitor fields
