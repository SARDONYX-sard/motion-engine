//! Rust [`Serializer`]/[`Deserializer`] corresponding to C++ class `hkbComputeRotationToTargetModifierInternalState`
//!
//! # NOTE
...
#[serde(tag = "@name")]
pub enum HkbComputeRotationToTargetModifierInternalState {
    /// # C++ Class Fields Info
    /// -   name:`"rotationOut"`
    /// -   type: `hkQuaternion`
    /// - offset: 16
