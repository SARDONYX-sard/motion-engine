...
impl ByteDeSerialize for HkpVehicleDefaultSuspensionWheelSpringSuspensionParameters {
    fn from_bytes<B>(
        _bytes: &[u8],
...
#[serde(tag = "@name")]
pub enum HkpVehicleDefaultSuspensionWheelSpringSuspensionParametersVisitor {
    /// Visitor fields
