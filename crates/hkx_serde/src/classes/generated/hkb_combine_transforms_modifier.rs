...
pub struct HkbCombineTransformsModifier<'a> {
    ...
    /// - offset: 80
    /// -  flags: `FLAGS_NONE`
    left_translation: Vector4<f32>,
    /// # C++ Class Fields Info
    /// -   name:`"leftRotation"`
    /// -   type: `hkQuaternion`
    /// - offset: 96
    /// -  flags: `FLAGS_NONE`
    left_rotation: Quaternion<f32>,
    /// # C++ Class Fields Info
    /// -   name:`"rightTranslation"`
    /// -   type: `hkVector4`
    /// - offset: 112
    /// -  flags: `FLAGS_NONE`
    right_translation: Vector4<f32>,
    /// # C++ Class Fields Info
    /// -   name:`"rightRotation"`
    /// -   type: `hkQuaternion`
    /// - offset: 128
    /// -  flags: `FLAGS_NONE`
    right_rotation: Quaternion<f32>,
    /// # C++ Class Fields Info
    /// -   name:`"invertLeftTransform"`
    /// -   type: `hkBool`
    /// - offset: 144
    /// -  flags: `FLAGS_NONE`
    invert_left_transform: bool,
    /// # C++ Class Fields Info
    /// -   name:`"invertRightTransform"`
    /// -   type: `hkBool`
    /// - offset: 145
    /// -  flags: `FLAGS_NONE`
    invert_right_transform: bool,
    /// # C++ Class Fields Info
    /// -   name:`"invertResult"`
    /// -   type: `hkBool`
    /// - offset: 146
...
impl ByteDeSerialize for HkbCombineTransformsModifier<'_> {
    fn from_bytes<B>(
        _bytes: &[u8],
...
#[serde(tag = "@name")]
pub enum HkbCombineTransformsModifierVisitor<'a> {
    /// Visitor fields
    #[serde(rename = "enable")]
