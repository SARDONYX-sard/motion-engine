...
pub struct HkbEventsFromRangeModifierInternalState {
    ...
    /// - offset: 8
    /// -  flags: `FLAGS_NONE`
    was_active_in_previous_frame: HkArrayRef<bool>,
}
...
impl ByteDeSerialize for HkbEventsFromRangeModifierInternalState {
    fn from_bytes<B>(
        _bytes: &[u8],
...
#[serde(tag = "@name")]
pub enum HkbEventsFromRangeModifierInternalStateVisitor {
    /// Visitor fields
