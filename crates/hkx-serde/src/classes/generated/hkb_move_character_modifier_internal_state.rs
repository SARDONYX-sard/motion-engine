//! Rust [`Serializer`]/[`Deserializer`] corresponding to C++ class `hkbMoveCharacterModifierInternalState`
//!
//! # NOTE
...
#[serde(tag = "@name")]
pub enum HkbMoveCharacterModifierInternalState {
    /// # C++ Class Fields Info
...
impl_deserialize_for_internally_tagged_enum! {
    HkbMoveCharacterModifierInternalState, "@name",
