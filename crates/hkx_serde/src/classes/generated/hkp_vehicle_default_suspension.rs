...
pub struct HkpVehicleDefaultSuspension {
    ...
    /// - offset: 8
    /// -  flags: `FLAGS_NONE`
    wheel_params: HkArrayClass<HkpVehicleSuspensionSuspensionWheelParameters>,
    ...
    /// - offset: 20
    /// -  flags: `FLAGS_NONE`
    wheel_spring_params: HkArrayClass<HkpVehicleDefaultSuspensionWheelSpringSuspensionParameters>,
}
...
impl ByteDeSerialize for HkpVehicleDefaultSuspension {
    fn from_bytes<B>(
        _bytes: &[u8],
...
#[serde(tag = "@name")]
pub enum HkpVehicleDefaultSuspensionVisitor {
    /// Visitor fields
