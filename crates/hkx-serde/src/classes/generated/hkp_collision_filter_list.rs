...
pub struct HkpCollisionFilterList<'a> {
    ...
    /// `"hkpCollisionFilterList"`: The original C++ class name.
...
impl HkpCollisionFilterList<'_> {
    /// Return `"hkpCollisionFilterList"`, which is the name of this C++ class.
    ///
    /// # NOTE
...
pub enum HkpCollisionFilterListHkParam<'a> {
    ...
    CollisionFilters(Vec<Cow<'a, str>>),
}
...
impl_deserialize_for_internally_tagged_enum! {
    ...
    ("collisionFilters" => CollisionFilters(Vec<Cow<'a, str>>)),
}
