...
pub struct HkaDeltaCompressedAnimation<'a> {
    ...
    /// - offset: 48
    /// -  flags: `FLAGS_NONE`
    q_format: SingleClass<HkaDeltaCompressedAnimationQuantizationFormat>,
    /// # C++ Class Fields Info
...
impl ByteDeSerialize for HkaDeltaCompressedAnimation<'_> {
    fn from_bytes<B>(
        _bytes: &[u8],
...
#[serde(tag = "@name")]
pub enum HkaDeltaCompressedAnimationVisitor<'a> {
    /// Visitor fields
    #[serde(rename = "type")]
