...
pub struct BsDirectAtModifier<'a> {
    ...
    /// - offset: 44
    /// -  flags: `FLAGS_NONE`
    direct_at_target: bool,
    /// # C++ Class Fields Info
    /// -   name:`"sourceBoneIndex"`
    /// -   type: `hkInt16`
    /// - offset: 46
    /// -  flags: `FLAGS_NONE`
    source_bone_index: i16,
    /// # C++ Class Fields Info
    /// -   name:`"startBoneIndex"`
    /// -   type: `hkInt16`
    /// - offset: 48
    /// -  flags: `FLAGS_NONE`
    start_bone_index: i16,
    /// # C++ Class Fields Info
    /// -   name:`"endBoneIndex"`
    /// -   type: `hkInt16`
    /// - offset: 50
    ...
    /// - offset: 52
    /// -  flags: `FLAGS_NONE`
    limit_heading_degrees: f32,
    /// # C++ Class Fields Info
    /// -   name:`"limitPitchDegrees"`
    /// -   type: `hkReal`
    /// - offset: 56
    /// -  flags: `FLAGS_NONE`
    limit_pitch_degrees: f32,
    /// # C++ Class Fields Info
    /// -   name:`"offsetHeadingDegrees"`
    /// -   type: `hkReal`
    /// - offset: 60
    /// -  flags: `FLAGS_NONE`
    offset_heading_degrees: f32,
    /// # C++ Class Fields Info
    /// -   name:`"offsetPitchDegrees"`
    /// -   type: `hkReal`
    /// - offset: 64
    /// -  flags: `FLAGS_NONE`
    offset_pitch_degrees: f32,
    /// # C++ Class Fields Info
    /// -   name:`"onGain"`
    /// -   type: `hkReal`
    /// - offset: 68
    ...
    /// - offset: 100
    /// -  flags: `FLAGS_NONE`
    direct_at_camera: bool,
    /// # C++ Class Fields Info
    /// -   name:`"directAtCameraX"`
    /// -   type: `hkReal`
    /// - offset: 104
    /// -  flags: `FLAGS_NONE`
    direct_at_camera_x: f32,
    /// # C++ Class Fields Info
    /// -   name:`"directAtCameraY"`
    /// -   type: `hkReal`
    /// - offset: 108
    /// -  flags: `FLAGS_NONE`
    direct_at_camera_y: f32,
    /// # C++ Class Fields Info
    /// -   name:`"directAtCameraZ"`
    /// -   type: `hkReal`
    /// - offset: 112
    /// -  flags: `FLAGS_NONE`
    direct_at_camera_z: f32,
    /// # C++ Class Fields Info
    /// -   name:`"active"`
    /// -   type: `hkBool`
    /// - offset: 116
    ...
    /// - offset: 144
    /// -  flags: `FLAGS_NONE|SERIALIZE_IGNORED`
    direct_at_target_location: Vector4<f32>,
    /// # C++ Class Fields Info
    /// -   name:`"boneChainIndices"`
    /// -   type: `hkArray<void>`
    /// - offset: 160
    /// -  flags: `FLAGS_NONE|SERIALIZE_IGNORED`
    bone_chain_indices: HkArrayRef<()>,
}
...
impl ByteDeSerialize for BsDirectAtModifier<'_> {
    fn from_bytes<B>(
        _bytes: &[u8],
...
#[serde(tag = "@name")]
pub enum BsDirectAtModifierVisitor<'a> {
    /// Visitor fields
    #[serde(rename = "enable")]
