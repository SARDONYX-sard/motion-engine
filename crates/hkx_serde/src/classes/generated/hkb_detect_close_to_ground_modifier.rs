...
pub struct HkbDetectCloseToGroundModifier<'a> {
    ...
    /// - offset: 44
    /// -  flags: `FLAGS_NONE`
    close_to_ground_event: SingleClass<HkbEventProperty<'a>>,
    /// # C++ Class Fields Info
    /// -   name:`"closeToGroundHeight"`
    /// -   type: `hkReal`
    /// - offset: 52
    /// -  flags: `FLAGS_NONE`
    close_to_ground_height: f32,
    /// # C++ Class Fields Info
...
impl ByteDeSerialize for HkbDetectCloseToGroundModifier<'_> {
    fn from_bytes<B>(
        _bytes: &[u8],
...
#[serde(tag = "@name")]
pub enum HkbDetectCloseToGroundModifierVisitor<'a> {
    /// Visitor fields
    #[serde(rename = "enable")]
