...
pub enum HkbTwistModifier {
    ...
    /// - offset: 48
    /// -  flags: `FLAGS_NONE`
    #[serde(rename = "axisOfRotation", default)]
    ...
    /// - offset: 64
    /// -  flags: `FLAGS_NONE`
    #[serde(rename = "twistAngle", default)]
    ...
    /// - offset: 72
    /// -  flags: `FLAGS_NONE`
    #[serde(rename = "setAngleMethod", default)]
    ...
    /// - offset: 73
    /// -  flags: `FLAGS_NONE`
    #[serde(rename = "rotationAxisCoordinates", default)]
    ...
    /// - offset: 88
    /// -  flags: `FLAGS_NONE | SERIALIZE_IGNORED`
    #[serde(rename = "parentBoneIndices", default, skip_serializing)]
