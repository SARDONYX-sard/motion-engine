...
pub struct HkpVehicleDefaultBrake {
    ...
    /// - offset: 8
    /// -  flags: `FLAGS_NONE`
    wheel_braking_properties: HkArrayClass<HkpVehicleDefaultBrakeWheelBrakingProperties>,
    /// # C++ Class Fields Info
    /// -   name:`"wheelsMinTimeToBlock"`
    /// -   type: `hkReal`
    /// - offset: 20
    /// -  flags: `FLAGS_NONE`
    wheels_min_time_to_block: f32,
}
...
impl ByteDeSerialize for HkpVehicleDefaultBrake {
    fn from_bytes<B>(
        _bytes: &[u8],
...
#[serde(tag = "@name")]
pub enum HkpVehicleDefaultBrakeVisitor {
    // C++ Parent class(`hkpVehicleBrake` => parent: `hkReferencedObject`) has no fields
    //
    /// Visitor fields
