...
pub struct HkxMaterialShader<'a> {
    ...
    /// - offset: 16
    /// -  flags: `FLAGS_NONE`
    vertex_entry_name: Cow<'a, str>,
    /// # C++ Class Fields Info
    /// -   name:`"geomEntryName"`
    /// -   type: `hkStringPtr`
    /// - offset: 20
    /// -  flags: `FLAGS_NONE`
    geom_entry_name: Cow<'a, str>,
    /// # C++ Class Fields Info
    /// -   name:`"pixelEntryName"`
    /// -   type: `hkStringPtr`
    /// - offset: 24
    /// -  flags: `FLAGS_NONE`
    pixel_entry_name: Cow<'a, str>,
    /// # C++ Class Fields Info
    /// -   name:`"data"`
...
impl ByteDeSerialize for HkxMaterialShader<'_> {
    fn from_bytes<B>(
        _bytes: &[u8],
...
#[serde(tag = "@name")]
pub enum HkxMaterialShaderVisitor<'a> {
    /// Visitor fields
