...
pub struct HkbEvaluateHandleModifier<'a> {
    ...
    /// - offset: 48
    /// -  flags: `FLAGS_NONE`
    handle_position_out: Vector4<f32>,
    /// # C++ Class Fields Info
    /// -   name:`"handleRotationOut"`
    /// -   type: `hkQuaternion`
    /// - offset: 64
    /// -  flags: `FLAGS_NONE`
    handle_rotation_out: Quaternion<f32>,
    /// # C++ Class Fields Info
    /// -   name:`"isValidOut"`
    /// -   type: `hkBool`
    /// - offset: 80
    ...
    /// - offset: 96
    /// -  flags: `FLAGS_NONE|SERIALIZE_IGNORED`
    old_handle: SingleClass<HkbHandle<'a>>,
    /// # C++ Class Fields Info
    /// -   name:`"oldHandlePosition"`
    /// -   type: `hkVector4`
    /// - offset: 128
    /// -  flags: `FLAGS_NONE|SERIALIZE_IGNORED`
    old_handle_position: Vector4<f32>,
    /// # C++ Class Fields Info
    /// -   name:`"oldHandleRotation"`
    /// -   type: `hkQuaternion`
    /// - offset: 144
    /// -  flags: `FLAGS_NONE|SERIALIZE_IGNORED`
    old_handle_rotation: Quaternion<f32>,
    /// # C++ Class Fields Info
    ...
    /// - offset: 164
    /// -  flags: `FLAGS_NONE|SERIALIZE_IGNORED`
    smoothly_changing_handles: bool,
}
...
impl ByteDeSerialize for HkbEvaluateHandleModifier<'_> {
    fn from_bytes<B>(
        _bytes: &[u8],
...
#[serde(tag = "@name")]
pub enum HkbEvaluateHandleModifierVisitor<'a> {
    /// Visitor fields
    #[serde(rename = "enable")]
