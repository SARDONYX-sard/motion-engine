...
pub struct HkpDisplayBindingData<'a> {
    ...
    /// - offset: 8
    /// -  flags: `FLAGS_NONE`
    rigid_body_bindings: HkArrayRef<Cow<'a, str>>,
    /// # C++ Class Fields Info
    /// -   name:`"physicsSystemBindings"`
    /// -   type: `hkArray<hkpDisplayBindingDataPhysicsSystem*>`
    /// - offset: 20
    /// -  flags: `FLAGS_NONE`
    physics_system_bindings: HkArrayRef<Cow<'a, str>>,
}
...
impl ByteDeSerialize for HkpDisplayBindingData<'_> {
    fn from_bytes<B>(
        _bytes: &[u8],
...
#[serde(tag = "@name")]
pub enum HkpDisplayBindingDataVisitor<'a> {
    /// Visitor fields
