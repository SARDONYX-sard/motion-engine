//! Rust [`Serializer`]/[`Deserializer`] corresponding to C++ class `hkbRealVariableSequencedData`
//!
//! # NOTE
...
#[serde(tag = "@name")]
pub enum HkbRealVariableSequencedData {
    /// # C++ Class Fields Info
    /// -   name:`"samples"`
...
impl_deserialize_for_internally_tagged_enum! {
    HkbRealVariableSequencedData, "@name",
