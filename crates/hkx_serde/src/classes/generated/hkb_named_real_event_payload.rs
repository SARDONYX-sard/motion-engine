//! Rust [`serde::Serializer`]/[`serde::Deserializer`] corresponding to C++ class `hkbNamedRealEventPayload`
//!
//! # NOTE
...
impl <'bytes: 'de, 'de> ByteDeSerialize<'bytes, 'de> for HkbNamedRealEventPayload<'de> {
    fn from_bytes<B>(
        _bytes: &'bytes [u8],
...
#[serde(tag = "@name")]
enum HkbNamedRealEventPayloadVisitor<'a> {
    /// Visitor fields
    #[serde(rename = "name")]
